fetch('https://site.api.espn.com/apis/site/v2/sports/football/college-football/scoreboard?dates=20250828-20250901') // Replace with your API endpoint
  .then(response => {
  ...
  .then(data => {
    ...
    document.getElementById("week2games").appendChild(gameName);
    }
    console.log(data);
  })
  .catch(error => {
