...
function savePicks(user, weekNum) {
  const form = document.getElementById('Week4picksform');
...
async function loadGames(weekNum, user) {
  const container = document.getElementById('week4games');
  container.innerHTML = '';

  try {
    const res = await fetch('https://site.api.espn.com/apis/site/v2/sports/football/college-football/scoreboard?dates=20250918-20250920');
    const data = await res.json();
    const targetEventIds = ["401762468","401752844","401756901","401752708","401754636","401760376","401762469","401752714","401752846","401754640","401757262","401761610","401761613","401754538","401757259","401757261","401757264","401752709","401752843","401756896","401756898","401757263","401757267","401760373","401760374"];
